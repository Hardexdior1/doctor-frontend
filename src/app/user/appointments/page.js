  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex border-b border-gray-200 mb-4 justify-between md:justify-start">
       ...
       <div className="transition grid gap-5 grid-cols-2 md:grid-cols-2 xl:grid-cols-4 ">
                {isLoading
                ...
                <div>
                    {activeTab=="past"&& past.map((doc, index) => (
                    <div key={index+1} className="flex flex-col border border-gray-200 rounded-lg shadow-sm overflow-hidden text-center">
                    <Image
                    ...
                    <div className="flex flex-col gap-1 py-3 px-4 text-left">
                      <h3 className="text-lg font-bold">{doc.doctorId.name}</h3>
                      <p className="text-sm text-[#207dff] font-medium">{doc.doctorId.specialty}</p>
                      <p className="text-gray-500 text-sm italic">{ doc.diagnosis||doc.message }</p>
                      ...
                      <div className="flex justify-between text-sm text-gray-700 mt-2">
                        ...
                        <span> {new Date(doc.date).toLocaleDateString("en-US",{
                         ...
                         </span> -  <span> {new Date(doc.date).toLocaleTimeString("en-US", {
                          hour: "numeric",
                          minute: "numeric",
                          hour12: true,
                        })}
                      ...
                      <div className="flex justify-between text-sm text-gray-700">
                        ...
                        <span>₦5,000</span> {/* hardcoded for now */}
                      </div>
...
{activeTab=="coming"&& comingAppointments.map((doc, index) => (
                    <div key={index+1} className="flex flex-col border border-gray-200 rounded-lg shadow-sm overflow-hidden text-center">
                    <Image
                      src={doc.doctorId.image}
                      alt={doc.doctorId.name}
